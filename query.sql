...
/*6. Find the maximum and minimum driver ratings for Prime Sedan bookings:v*/

SELECT MAX(Driver_Ratings) as max_rating, MIN(Driver_Ratings) as min_rating FROMv
